...
//                orow.createCell(0).setCellValue(ques.get(itr).getAttribute("id"));
                    ...
                    String ID = s1[itr];
                    web.get("https://course.codequotient.com/quest/add/" + ID);
                    Thread.sleep(1000);

                    XSSFRow orow = odsheet.createRow(rc++);
                int ccount =0;
                    orow.createCell(ccount++).setCellValue(ID);
                    if(Objects.equals(web.getCurrentUrl(), "https://course.codequotient.com/quest/add/" + ID))
                    {
...
//                        System.out.println(title + score + type +des);
                        ...
                        orow.createCell(ccount++).setCellValue("https://course.codequotient.com/quest/preview/"+ID);
